...
public class JogadorVingadoresDataUtil implements JogadorInterface {
    ...
    public static final JogadorPostResponse JOGADOR_POST_RESPONSE = JogadorPostResponse.builder()
            .codinome(JOGADOR_SAVED_WITH_ID.getCodinome())
            .email(JOGADOR_SAVED_WITH_ID.getEmail())
            .grupoCodinome(JOGADOR_SAVED_WITH_ID.getGrupoCodinome())
            .id(JOGADOR_SAVED_WITH_ID.getId())
            .nome(JOGADOR_SAVED_WITH_ID.getNome())
            .telefone(JOGADOR_SAVED_WITH_ID.getTelefone())
            .build();
